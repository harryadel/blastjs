...
test('minimongo - modifier affects selector', () => {
  function testSelectorPaths(sel, paths, desc) {
    const matcher = new Minimongo.Matcher(sel);
    expect(matcher._getPaths()).toEqual(paths, desc);
  }
  ...
  function testSelectorAffectedByModifier(sel, mod, yes, desc) {
    const matcher = new Minimongo.Matcher(sel);
    expect(matcher.affectedByModifier(mod)).toEqual(yes);
  }
...
// test('minimongo - selector and projection combination', () => {
//   function testSelProjectionComb(sel, proj, expected, desc) {
//     const matcher = new Minimongo.Matcher(sel);
//     expect(matcher.combineIntoProjection(proj)).toEqual(expected);
//   }

//   // Test with inclusive projection
//   testSelProjectionComb({ a: 1, b: 2 }, { b: 1, c: 1, d: 1 }, {
//     a: true, b: true, c: true, d: true,
//   }, 'simplest incl');
//   testSelProjectionComb({ $or: [{ a: 1234, e: { $lt: 5 } }], b: 2 }, { b: 1, c: 1, d: 1 }, {
...
// test('minimongo - sorter and projection combination', () => {
//   function testSorterProjectionComb(sortSpec, proj, expected, desc) {
//     const sorter = new Minimongo.Sorter(sortSpec);
//     expect(sorter.combineIntoProjection(proj)).toEqual(expected);
//   }

//   // Test with inclusive projection
//   testSorterProjectionComb({ a: 1, b: 1 }, { b: 1, c: 1, d: 1 }, {
//     a: true, b: true, c: true, d: true,
//   }, 'simplest incl');
//   testSorterProjectionComb({ a: 1, b: -1 }, { b: 1, c: 1, d: 1 }, {
//     a: true, b: true, c: true, d: true,
...
//   const matcher = new Minimongo.Matcher(sel);
//   expect(matcher.canBecomeTrueByModifier(mod)).toEqual(expected);
// };
...
// test('minimongo - can selector become true by modifier - literals (structured tests)', () => {
//   test = t;
...
// test('minimongo - can selector become true by modifier - literals (adhoc tests)', () => {
//   test = t;
...
// test('minimongo - can selector become true by modifier - regexps', () => {
//   test = t;
...
// test('minimongo - can selector become true by modifier - undefined/null', () => {
//   test = t;
//   // Nulls / Undefined
...
// test('minimongo - can selector become true by modifier - literals with arrays', () => {
//   test = t;
...
// test('minimongo - can selector become true by modifier - set an object literal whose fields are selected', () => {
//   test = t;
...
// test('minimongo - can selector become true by modifier - $-scalar selectors and simple tests', () => {
//   test = t;
...
//   T({
//     a: {
//       $lte: 10, $gte: 3, $gt: 3, $lt: 10,
//     },
//   }, { $set: { a: 4 } }, 'set between x and y');
//   F({
//     a: {
//       $lte: 10, $gte: 3, $gt: 3, $lt: 10,
//     },
//   }, { $set: { a: 3 } }, 'set between x and y');
//   F({
//     a: {
//       $lte: 10, $gte: 3, $gt: 3, $lt: 10,
//     },
//   }, { $set: { a: 10 } }, 'set between x and y');
//   F({
//     a: {
//       $lte: 10, $gte: 3, $gt: 3, $lt: 10,
//     },
//   }, { $set: { a: Infinity } }, 'set between x and y');
//   T({
//     a: {
//       $lte: 10, $gte: 3, $gt: 3, $lt: 10,
//     },
//     x: 1,
//   }, { $set: { x: 1 } }, 'set between x and y - dummy');
//   F({
//     a: {
//       $lte: 10, $gte: 13, $gt: 3, $lt: 9,
//     },
//     x: 1,
//   }, { $set: { x: 1 } }, 'set between x and y - dummy - impossible');
...
// test('minimongo - can selector become true by modifier - $-nonscalar selectors and simple tests', () => {
//   test = t;
