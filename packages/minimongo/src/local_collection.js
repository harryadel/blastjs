...
import { _SynchronousQueue } from './fiber_stub_client';
...
export class LocalCollection {
  constructor(name) {
    ...
    this._observeQueue = new _SynchronousQueue();
...
LocalCollection._CachingChangeObserver = _CachingChangeObserver;

LocalCollection._IdMap = _IdMap;
...
LocalCollection.wrapTransform = _wrapTransform;
...
LocalCollection._checkSupportedProjection = _checkSupportedProjection;
...
//                       of passed argument.
LocalCollection._compileProjection = _compileProjection;
...
LocalCollection._diffObjects = (left, right, callbacks) => DiffSequence.diffObjects(left, right, callbacks);
