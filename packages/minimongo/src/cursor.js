...
import {
  hasOwn, _selectorIsIdPerhapsAsObject, _compileProjection, _wrapTransform, _observeChangesCallbacksAreOrdered, _IdMap,
...
export default class Cursor {
  ...
  constructor(collection, selector, options = {}) {
    ...
    this._transform = _wrapTransform(options.transform);
