...
Meteor.Random = require("meteor-random");
Meteor.EJSON = require("meteor-ejson");
_ = Meteor.underscore = global._ = require("underscore");

require("meteor-tinytest")(Meteor);

Tinytest = Meteor.Tinytest;
...
require("./charref_tests.js");
require("./compile_tests.js");
require("./html-scanner-tests.js");
require("./htmljs_test.js");
require("./parse_tests.js");
require("./spacebars_tests.js");
require("./token_tests.js");
require("./tokenize_tests.js");
...
Tinytest._runTests((arg1) => {
  if (arg1.events.length) {
    if (arg1.events[0].type === "exception") {
      console.log("failed", arg1.test, arg1.events[0].details);
    }
    else if (arg1.events[0].type === "finish") {
      console.log("passed", arg1.test, arg1.events[0].timeMs);
    }
  }
  else {
    console.log("started", arg1.test);
  }
}, (arg1) => {
