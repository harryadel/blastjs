...
var getChars = HTMLTools.makeRegexMatcher(/^[^&<\u0000][^&<\u0000{]*/);
...
var getTagName = HTMLTools.makeRegexMatcher(/^[a-zA-Z][^\f\n\r\t />{]*/);
var getClangle = HTMLTools.makeRegexMatcher(/^>/);
var getSlash = HTMLTools.makeRegexMatcher(/^\//);
var getAttributeName = HTMLTools.makeRegexMatcher(/^[^>/\u0000"'<=\f\n\r\t ][^\f\n\r\t /=>"'<\u0000]*/);
